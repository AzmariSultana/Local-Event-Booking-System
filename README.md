...
ii. Book up to 5 tickets per event.
...
ii. 15% group discount for 3+ tickets.

iii. Accepts coupon codes for extra savings.
...
ii. Simulates a small administrative backend.
...
Recommended Emulator: EMU8086

# How to Run

i. Open the .asm file in EMU8086.

ii. Compile the code.

iii. Run the program and navigate menus using the keyboard.

iv. Try booking events, adding extras, applying discounts, or exploring admin mode!
